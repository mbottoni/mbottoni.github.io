...
\textbf{MSc in Computer Science}, University of São Paulo (USP) \hfill \textit{2023 -- 2026} \\
Systems Biology and Systems Neuroscience group \\
\textit{Thesis}: Modeling the structure of complex networks: a generative approach using a logistic random graph model \\
